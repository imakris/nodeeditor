...
void draw_nine_slice_shadow(QPainter* painter, QColor shadow_color, QRectF const& node_rect)
{
    ...
    // Covers the full blur transition
    ...
    const qreal source_margin = m;
    const qreal source_body   = static_cast<qreal>(k_body_size);
    ...
    const QRectF s_tl(0, 0, source_margin, source_margin);
    const QRectF s_tc(source_margin, 0, source_body, source_margin);
    const QRectF s_tr(source_margin + source_body, 0, source_margin, source_margin);
    const QRectF s_ml(0, source_margin, source_margin, source_body);
    const QRectF s_mc(source_margin, source_margin, source_body, source_body);
    const QRectF s_mr(source_margin + source_body, source_margin, source_margin, source_body);
    const QRectF s_bl(0, source_margin + source_body, source_margin, source_margin);
    const QRectF s_bc(source_margin, source_margin + source_body, source_body, source_margin);
    const QRectF s_br(
        source_margin + source_body,
        source_margin + source_body,
        source_margin,
        source_margin);
