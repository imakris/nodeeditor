...
QtNodes::AbstractGraphModel::ConnectionIdSet const &SimpleGraphModel::allConnectionIds(
    NodeId const nodeId) const
{
    return _connectionIndex.allConnectionIds(nodeId);
}

QtNodes::AbstractGraphModel::ConnectionIdSet const &SimpleGraphModel::connections(
...
bool SimpleGraphModel::connectionPossible(
...
SimpleGraphModel::prepareConnectionReplacement(
